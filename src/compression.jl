...
# TODO use proper function for testing - comparison only
...
function compress_iter(ψ::MPS{T}, χ::Int, threshold::Float64) where T <: AbstractFloat
    compress(ψ, χ, threshold)
end
